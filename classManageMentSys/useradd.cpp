    ...
    ui(new Ui::userAdd)
{
    ...
    connect(ui->CloseBtn,&QPushButton::clicked,this,&userAdd::close);//这个牛逼
...
void userAdd::mousePressEvent(QMouseEvent *event)
{
...
//···鼠标移动操作···
//实时修改窗口的坐标
void userAdd::mouseMoveEvent(QMouseEvent *event)
{
...
//···鼠标释放操作···
void userAdd::mouseReleaseEvent(QMouseEvent *event)
{
...
void userAdd::SaveBtnC()
{

    this->hide();
}

void userAdd::on_CancleBtn_clicked()
{
    this->hide();
}
